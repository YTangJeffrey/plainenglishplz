import type { AudienceTone, ChatMessage } from '../types';
...
const toneDescriptions: Record<AudienceTone, string> = {
  ...
  cynic: 'Explain in plain english for a general adult audience, avoid jargon and stay concise but employ sarcasm and humor',
};
